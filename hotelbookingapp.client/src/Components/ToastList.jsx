...
export default function ToastList({ toasts, removeToast }) {
  ...
  return (
    ...
    >
      {toasts.map((toast) => (
        <div className=' w-full max-w-xs p-3 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800'>
